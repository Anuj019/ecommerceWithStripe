...
const handleSubmit = async(ev) => {
 ...
 history.push('/')
  ...
  return <div>
    ...
    >  <span id='button-text'>
       {processing ? <div className='spinner' id="spinner"> </div>: 'pay'}</span></button>
       {/* show Any error that happens when processeing the payemt  */}
       {error && <div className='card-error'role='alert'>
         {error}
         {/* show success msg upon completion  */}
